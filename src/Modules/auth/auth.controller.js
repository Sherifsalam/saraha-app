...
router.patch("/update_password", authMiddleware, updatePassword);

router.post("/update_email", authMiddleware, updateEmail);

router.patch("/confirm_update_email", authMiddleware ,ConfirmUpatEmail);
